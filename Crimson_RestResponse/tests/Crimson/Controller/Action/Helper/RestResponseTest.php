...
require_once 'Crimson/Controller/Action/Helper/RestResponse.php';

class Crimson_Controller_Action_Helper_RestResponseTest extends PHPUnit_Framework_TestCase 
{
    public function setUp()
    {
        ...
        $this->helper = new Crimson_Controller_Action_Helper_RestResponse;
    }
