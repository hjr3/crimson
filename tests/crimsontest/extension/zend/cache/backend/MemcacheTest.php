...
use Zend_Cache_CommonExtendedBackendTest;
use crimson\extension\zend\cache\backend\Memcache;
 ...
 * @group      Zend_Cache
 */
class MemcacheTest extends Zend_Cache_CommonExtendedBackendTest {
    
    protected $_instance;
 
    public function __construct($name = null, array $data = array(), $dataName = '')
    {
        parent::__construct('Memcache', $data, $dataName);
    }
    ...
    {        
        ...
        $this->_instance = new Memcache($options);
        parent::setUp($notag);    
    }
